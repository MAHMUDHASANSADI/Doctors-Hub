...
<body>
  ...
  <div class="container ">
    ...
    <div class="container border border-warning border-3 w-50 mt-5 alert alert-success">
      <div>
        <h5 class="pt-3 text-center ">Patient name :
          <?php if (isset($rows2['patient_name']))
            echo $rows2['patient_name']; ?>
        </h5>
        <h5 class="pt-3 text-center ">Patient age :
          <?php if (isset($rows2['age']))
            echo $rows2['age']; ?>
        </h5>
        <h5 class="pt-3 text-center ">Doctor Name :
          <?php if (isset($rows['doctor_name']))
            echo 'Dr. ' . $rows['doctor_name']; ?>
        </h5>
        <h5 class="pt-3 text-center">Doctor phone :
          <?php if (isset($rows['phone']))
            echo $rows['phone']; ?>
        </h5>
        <h5 class="pt-3 text-center">Doctor email :
          <?php if (isset($rows['email']))
            echo $rows['email']; ?>
        </h5>
        <h5 class="pt-3 text-center">Doctor specialisation :
          <?php if (isset($rows['specialization']))
            echo $rows['specialization']; ?>
        </h5>
        <h5 class="pt-3 text-center">Schedule :
          <?php if (isset($rows['schedule']))
            echo $rows['schedule']; ?>
        </h5>
      </div>
    </div>
